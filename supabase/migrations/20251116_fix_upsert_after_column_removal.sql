...
'Upserts subscriber event data. REPLACES event counts (not incremental) since we fetch a 15-day rolling window each sync. Loop-based implementation - use upsert_subscribers_incremental_optimized for better performance.';
