-- Migration: Fix ROW_NUMBER type mismatch in analyze_portfolio_copy_paths
-- Created: 2025-12-02
-- Purpose: Cast ROW_NUMBER() results to INT to match function signature
-- Error: Returned type bigint does not match expected type integer in column 2
...
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '✅ Fixed ROW_NUMBER type mismatch in analyze_portfolio_copy_paths';
  RAISE NOTICE '   - Cast ROW_NUMBER() results to INT (was BIGINT)';
  RAISE NOTICE '';
END $$;
