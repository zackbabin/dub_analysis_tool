-- Rename created_at column to inception_date in portfolio_performance_metrics table
ALTER TABLE portfolio_performance_metrics
RENAME COLUMN created_at TO inception_date;

-- Update the materialized view to use inception_date
