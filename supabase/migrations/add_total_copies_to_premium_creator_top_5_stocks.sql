-- Add total_copies column to premium_creator_top_5_stocks view
-- This column is needed for sorting creators by engagement in the UI

-- Drop the existing view
DROP VIEW IF EXISTS premium_creator_top_5_stocks CASCADE;

-- Recreate the view with total_copies column
