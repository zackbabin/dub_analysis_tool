-- Migration: Fix sorting in copy path analysis functions
-- Created: 2025-12-05
-- Purpose: Sort top_viewed by percentage DESC instead of total count DESC

-- ===========================================
-- 1. Fix Portfolio Copy Path Analysis Sorting
-- ===========================================
...
-- ===========================================
-- 2. Fix Creator Copy Path Analysis Sorting
-- ===========================================
...
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '✅ Fixed copy path sorting to use percentage DESC';
  RAISE NOTICE '   - Top portfolios/creators now sorted by pct_of_converters (highest to lowest)';
  RAISE NOTICE '';
END $$;
