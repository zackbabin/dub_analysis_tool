-- Update premium_creator_top_5_stocks to rank stocks by % of total copy capital
-- Changes: ORDER BY (stock_value / total_copy_capital) DESC instead of quantity DESC
-- This shows stocks that represent the largest allocation percentages
-- Date: 2025-11-17
