...
-- Created: 2025-12-10
-- Purpose: Fully qualify portfolio_sequence to avoid ambiguity with output column
...
BEGIN
  ...
  RAISE NOTICE '   - Fully qualified portfolio_sequence as us.portfolio_sequence';
  RAISE NOTICE '';
END $$;
