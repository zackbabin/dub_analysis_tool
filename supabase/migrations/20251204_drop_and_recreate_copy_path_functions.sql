-- Drop and recreate copy path analysis functions with correct BIGINT type for path_rank
...
-- Recreate with BIGINT path_rank
...
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '✅ Dropped and recreated copy path analysis functions';
  RAISE NOTICE '   - Fixed path_rank type: INT → BIGINT';
  RAISE NOTICE '   - Both functions now return BIGINT for path_rank column';
  RAISE NOTICE '';
END $$;
