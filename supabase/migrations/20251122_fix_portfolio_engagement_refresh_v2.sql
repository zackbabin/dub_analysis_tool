-- Migration: Fix refresh_portfolio_engagement_views (v2 - forced update)
-- Created: 2025-11-22
-- Purpose: Remove premium_creator_top_5_stocks from refresh (it's a regular view now)
--
-- Issue: Previous migration may not have applied correctly
-- This forces the function update with a new timestamp
