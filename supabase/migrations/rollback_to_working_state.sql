-- ROLLBACK: Restore views to working state
-- Issue: premium_creator_portfolio_metrics is empty, causing all metrics to be NULL
-- Solution: Go back to using user_portfolio_creator_engagement for aggregation until data is properly synced
...
-- ============================================================================
-- Restore portfolio_creator_engagement_metrics using user-level data
-- ============================================================================
...
SELECT
  ...
  -- Sum total PDP views FROM USER DATA
...
-- ============================================================================
-- Restore hidden_gems_portfolios
-- ============================================================================
...
-- ============================================================================
-- Restore premium creator affinity using user-level data
-- ============================================================================
...
premium_totals AS (
  -- Count unique portfolio copies, not sum of copy_count
  SELECT
    premium_creator,
...
'Aggregated portfolio-creator engagement metrics from user-level data. Uses SUM for totals until premium_creator_portfolio_metrics is populated.';
...
'Premium creator affinity analysis using user-level engagement data.';
