-- Fix analyze_unified_copy_paths to use first_app_open_time instead of kyc_approved_time
-- The column was renamed in user_first_copies table
...
DO $$
BEGIN
  RAISE NOTICE '✅ Fixed analyze_unified_copy_paths to use first_app_open_time';
END $$;
