        ...
        section.innerHTML = `
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.25rem;">
                ...
                <div style="display: flex; gap: 10px; align-items: center;">
                    ...
                    <button onclick="if(window.showCreatorUploadModal && window.creatorAnalysisTool) window.showCreatorUploadModal(window.creatorAnalysisTool); else if(window.userAnalysisTool) window.userAnalysisTool.runWorkflow('upload')" style="padding: 8px 16px; background: #6c757d; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 14px; font-weight: 500; transition: background 0.2s;" onmouseover="this.style.background='#5a6268'" onmouseout="this.style.background='#6c757d'">Upload Data</button>
