...
class UserAnalysisToolSupabase extends UserAnalysisTool {
    ...
    async buildCompleteHTML(results) {
                ...
                <div class="qda-result-section">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.25rem;">
                        ...
                        <div style="display: flex; gap: 10px; align-items: center;">
                            ...
                            <button disabled style="padding: 8px 16px; background: #e9ecef; color: #adb5bd; border: none; border-radius: 6px; cursor: not-allowed; font-size: 14px; font-weight: 500; opacity: 0.6;">Upload Data</button>
        ...
        const tabConfigs = [
            ...
            { container: portfolioContainer, scopeText: 'All users in last 60 days who have been KYC approved' }
        ];
